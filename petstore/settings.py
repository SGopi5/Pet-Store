...
TBD=os.path.join(BD,'template')
SBD=os.path.join(BD,'static')
...
SECRET_KEY = 'django-insecure-t(=s-o!@q)4ee#s&pn#!gu-6$9#%&!nai)9w)%ryt&#^y4c-#a'
...
EMAIL_HOST_USER='lvlyking143@gmail.com'
EMAIL_HOST_PASSWORD='drxu lwkl vwng ecel'
EMAIL_PORT=587
EMAIL_USE_TLS=True
